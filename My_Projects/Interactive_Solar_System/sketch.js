...
function drawSliders() {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    if (i < 3) {
      sliderGroup[i].position(windowInnerWidth * 0.106, height + i * 75 + 37);
    } else if (i >= 3 && i != 6) {
      sliderGroup[i].position(windowInnerWidth * 0.376, height + (i - 3) * 75 + 37);
    } else if (i == 6) {
      sliderGroup[i].position(windowInnerWidth * 0.646, height + (i - 6) * 75 + 37);
    }
    h = map(i, 0, 6, 5, 85);
...
function drawResetButtons() {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    if (i < 3) {
      resetButtons[i].position(windowInnerWidth * 0.286, height + i * 75 + 5);
    } else if (i >= 3 && i != 6) {
      resetButtons[i].position(windowInnerWidth* 0.556, height + (i - 3) * 75 + 5);
    } else if (i == 6) {
      resetButtons[i].position(windowInnerWidth * 0.826, height + (i - 6) * 75 + 5);
    }
...
function drawLabels() {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    label.id(`label${i}`); // Adds unique id to each label
    if (i < 3) {
      label.position(windowInnerWidth * 0.106, height + i * 75 - 20);
    } else if (i >= 3 && i != 6) {
      label.position(windowInnerWidth * 0.376, height + (i - 3) * 75 - 20);
    } else {
      label.position(windowInnerWidth * 0.646, height + (i - 6) * 75 - 20);
    }
